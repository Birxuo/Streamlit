...
import { categorizeTransactions, findGaps, computeMonthlyTrends, detectOutliers, Transaction, FlaggedCategory } from "@/lib/finance-utils";
  ...
  return (
    ...
    >
      ...
      <div className="lg:pl-64 flex flex-col min-h-screen">
        <TopBar onReset={data ? () => { setData(null); setInsights(null); } : undefined} />
